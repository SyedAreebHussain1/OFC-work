                ...
                <Form >
                    ...
                    >
                        <Row>
                            ...
                            <Col xs={4}>
                                <img style={{ width: '100px', marginTop: '-20px' }} src="https://i.pinimg.com/originals/5d/b1/61/5db161c96c535ff826d387e010941e62.jpg" alt="" />
                            </Col>
                            <Col xs={4}>
                        ...
                        {/* <br /> */}
                        <div
                            style={{ borderBottom: '1px solid black', marginBottom: '10px', color: 'green' }}>
                            <h6 style={{ color: 'green' }}>PART 1 - Personal Information</h6>
                        </div>
                        <Row className="mb-3">
                            <Form.Group as={Col} >
                                <Form.Label>First Name</Form.Label>
                                <Form.Control style={sty}
                    ...
                    >
                        ...
                        >
                            <div>
                                ...
                                />
                                <Form.Check
                                    label={`Road Facing at 10% premium`}
                                />
                                <Form.Check
                                    label={`west Open`}
                                />
                            ...
                            <div>
                                <Form.Check
                                    label={`Special Location (at 10% premium)`}
                                />
                                <Form.Check
                                    label={`Corner at 10% premium`}
                                />
                                <Form.Label>Multiple Location Facing:</Form.Label>
                            </div>
                            <div>
                                <Form.Check
                                    label={`Park/green area Facing at 10% premium`}
                                />
                                <Form.Control
                                    style={{
                                        marginTop: '20px',
                    ...
                    <div style={{
                        ...
                        <div>
                            <Row>
                                ...
                                >
                                    <div style={{
                                        border: '2px solid black', height: '150px', width: '50%',
                            ...
                            <Form.Group as={Col}>
                                <Form.Label>Son/wife/daughter of (incase not related by blood to the applicant)</Form.Label>
                                <Form.Control
                                    style={sty}
                                    type="text"
                                    // placeholder="-"
                    ...
                    <div style={{
                        ...
                        <div
                            style={{
                                borderBottom: '1px solid black', marginBottom: '10px',
                                // display: 'flex' 
                            }}>
                            <div style={{ color: 'green' }}>Part 4 - Payment Details (For Office Use Only) </div>
                        </div>
                        <Row className="mb-3">
                            <Form.Group as={Col}>
                                <Form.Label>Crossed Cheque Demand Draft/Pay Order No.</Form.Label>
                                <Form.Control
                                    style={sty}
                                    type="text"
                                    // placeholder="-"
