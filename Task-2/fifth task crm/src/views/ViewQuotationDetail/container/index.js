...
const mapStateToProps = (state) => ({
  ...
  const mapDispatchToPrpos = (dispatch) => {
    return {
    GetAllQuotation: (page, limit, SaleQuotationNo ,QuotationStatusName,user_phone,OnSuccess, OnFailure) =>
    dispatch(GetAllQuotation(page,limit, SaleQuotationNo ,QuotationStatusName,user_phone,OnSuccess, OnFailure)),
