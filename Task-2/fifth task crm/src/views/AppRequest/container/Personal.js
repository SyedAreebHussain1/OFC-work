...
function Personal(props) {
  let cnic = "abc";
  const [fomedCninc, setFormedCnic] = useState([]);
  ...
  useEffect(() => {
    // console.log("LOCATION AT PERSONAL COMPONENT", location.state);
    setState({
      ...state,
  ...
  //   if(getlead !== null && getlead !== undefined){
  //     props.LeadId(getlead, onSuccesslead, OnFailureLead)
  //   }
  // },[getlead])
  ...
  //   }
  //   if (age >= 18) {
  //     setlead({ ...getlead, Dateofbirth: dateString });
  //   } else {
  ...
  useEffect(() => {
    if (props.Position && props.Position.length > 0) {
      ...
      //       setPlotPositions({
      //         corner: item.pos_id == 1 ? true : false,
      //         nextToCorner: item.pos_id == 2 ? true : false,
      //         normal: item.pos_id == 3 ? true : false,
      //         parkFacing: item.pos_id == 4 ? true : false,
      //         westOpen: item.pos_id == 5 ? true : false,
      //         roadFacing: item.pos_id == 6 ? true : false,
      //       });
      //       // if (item.pos_id == 2) {
      //       //   setPlotPositions({
      //       //     ...plotPositions,
