                ...
                return (
                  <tr key={index}>
                    ...
                    <td>
                      ...
                      <Button
                        color={
                          posts.House_StatusName == "Available"
                            ? "info"
                            : "danger"
                        }
                        id="proceed"
                        size="sm"
                        onClick={() => onLock(posts)}
                        disabled={
                          posts.House_StatusName == "Available" ? false : true
                        }
                        // disabled={posts.House_Status === 25 ? false : true}
                      >
                        <span className="btn-inner--text"></span>
                        <span className="btn-inner--icon">
                      ...
                      {/* <Button color="danger"   size="sm" onClick={()=>onLockk(posts)} >
                                   <span className="btn-inner--text"></span>
                                   <span className="btn-inner--icon">
                                   <i class="fas fa-arrow-right"></i>
                                   </span>
