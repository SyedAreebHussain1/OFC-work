...
const mapDispatchToPrpos = (dispatch) => {
  return {
    ...
    showPlotNo: (page,limit,Project_name, Sector_Name, House_StatusName, Plot_no, CategoryName,PlotType_Name, OnSuccess, OnFailure) =>
      dispatch(showPlotNo(page,limit,Project_name, Sector_Name, House_StatusName, Plot_no, CategoryName,PlotType_Name, OnSuccess, OnFailure)),
