...
import TableViewDocumentation from "../components/TableViewDocumentation";
import {
  getAllSupport,
  getStatus,
  updateSupportStatus,
          ...
          <div className="col">
            <Card className="shadow">
              <CardHeader className="border-0">
                <h3 className="mb-0"> View Documentation </h3>
              </CardHeader>
              <CardBody>
                <Row>
                  <Col lg="4" md="4" sm="6">
...
export default connect(mapStateToProps, mapDispatchToProps)(ViewDocumentation);
