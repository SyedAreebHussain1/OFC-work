...
const Filteration = (props) => {
    ...
    return (
                <TableOfApprovalReceipt ShowApprovalReceipt={props.ShowApprovalReceipt} Update={props.Update} ShowUpdateApprovalStatus={props.ShowUpdateApprovalStatus} ></TableOfApprovalReceipt>
    )
}
