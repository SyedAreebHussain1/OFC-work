              ...
              <Row>
                ...
                <Col lg="6" md="6" sm="12" xs="12">
                  ...
                  <Tooltip
                    ...
                    toggle={() => toggle("info")}
                  >
                    * Phone Number of Every Lead Should be different
                  </Tooltip>
                </Col>
              </Row>

              {/* <Col lg="4" md="4" sm="12" xs="12" className="col text-right">
                  <input
                    type="file"
                    id="fileinput"
                    accept=".xlsx, .xls, .csv"
            ...
            <CardBody>
              ...
              <Row>
                <Col lg="4" md="4" sm="6" xs="12">
                  <label className="form-control-label">Campaign Source</label>
                ...
                <Col lg="4" md="4" sm="6" xs="12">
                  <label className="form-control-label">Campaign Status</label>

                  <Input
                    id="exampleFormControlSelect1"
                    type="select"
                    value={body.orderstatus}
                    onChange={(e) => onChangeOrder(e.target.value)}
                  >
                    <option value="">Select Status</option>
                    {props.OrderReport !== null &&
                      props.OrderReport !== undefined &&
                      props.OrderReport.map((order) => {
                        return (
              ...
              <Row>
                <Col lg="4" md="4" sm="6" xs="12">
                  <label className="form-control-label">Select Agent</label>
                  <Select
